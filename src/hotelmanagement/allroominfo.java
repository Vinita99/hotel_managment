...
public class allroominfo extends javax.swing.JFrame {
      ...
      public ArrayList<User> userList()
    {
        ...
        try
        {
            ...
            while(rs.next())
            {
                user=new User(rs.getInt("number"),rs.getString("availability"),rs.getString("status"),rs.getInt("price"),rs.getString("type"));
                userList.add(user);
            }
        }
      ...
      public void  show_user()
      {
          ...
          for(int i=0;i<list.size();i++)
          {
             ...
             row[1]=list.get(i).getavailability(); 
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NUMBER", "AVAILABILITY", "STATUS", "PRICE", "TYPE"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(allroominfo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
