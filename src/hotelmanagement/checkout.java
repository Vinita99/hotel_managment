...
public class checkout extends javax.swing.JFrame {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jButton1, javax.swing.GroupLayout.PREFERRED_SIZE, 677, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jTextField1KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyTyped
       ...
       /* String name=jTextField1.getText();
        ...
        ResultSet rs;
        String q="select room from customer where name=?";
        try
            ...
            {
                JOptionPane.showMessageDialog(null,"No such customer available");
            }
            }
...
*/
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ResultSet rs2;
        String s2="UPDATE rooms SET status ='Dirty' where number=?";
        String s="UPDATE rooms SET availability ='Available' where number=?";
        String s1="delete from customer where name=?";
        try
            {ps=mysqlconn.getConnection().prepareStatement(s);
            ps1=mysqlconn.getConnection().prepareStatement(s1);
            ps2=mysqlconn.getConnection().prepareStatement(s2);
            ps.setString(1,room);
            ...
            {
              JOptionPane.showMessageDialog(null,"Your customer has checked out"); 
              jTextField1.setText("");
              jTextField4.setText("");
            }
            }
