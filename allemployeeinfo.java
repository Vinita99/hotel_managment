...
public class allemployeeinfo extends javax.swing.JFrame {
    ...
    public ArrayList<emp> empList()
    {
        ...
        try
        {
            ...
            while(rs.next())
            {
                user=new emp(rs.getString("name"),rs.getInt("age"),rs.getString("gender"),rs.getString("job"),rs.getInt("salary"),rs.getString("phone"));
                userList.add(user);
            }
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("All Employee Info");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NAME", "AGE", "GENDER", "JOB", "SALARY", "PHONE"
            }
        ));
